...
|---|---|---|---|
| **Malik** | 1 → 4 | ~6 min | Contexte, besoins, cas d'utilisation |
| **Swann** | 5 → 6 | ~7 min | Architecture, classes, DSS |
| **Cléry** | 7 → 9 | ~7 min | Maquettes, critères, code |
...
## Slide 1 — Accueil (Malik)

**⏱ ~1 min**

> _"Bonjour à tous, merci de votre présence. Nous sommes Malik, Swann et Cléry, et nous allons vous présenter aujourd'hui notre projet **GreenRoute**._
...
## Slide 2 — Problématique & Vision (Malik)
...
## Slide 3 — Périmètre fonctionnel (Malik)
...
## Slide 4 — Descriptions textuelles (Malik)
...
_Je passe la parole à Swann pour l'architecture."_

---

## Slide 5 — Diagramme de classes (Swann)
...
_Je passe la parole à Cléry pour la partie UI et code."_

---

## Slide 7 — Maquettes UI (Cléry)
...
## Slide 8 — Critères Bastien & Scapin (Cléry)
...
## Slide 9 — Implémentation Python (Cléry)
...
> _[Malik] : "Nous avons réparti le travail de manière équitable : cadrage et besoins pour moi, architecture pour Swann, UI et code pour Cléry."_

> _[Swann] : "Le barème se décompose ainsi : 4 points pour les besoins, 5 pour l'architecture, 5 pour l'IHM et le code, et 6 points pour la qualité du livrable et la soutenance."_

> _[Cléry] : "Nous sommes prêts pour vos questions. Nous avons préparé des réponses sur les choix techniques, la résilience, et les mesures d'impact écologique."_
...
| Slide | Titre | Qui |
|---|---|---|
| 1 | Accueil — GreenRoute | Malik |
| 2 | Problématique & Vision | Malik |
| 3 | Périmètre fonctionnel | Malik |
| 4 | Descriptions textuelles | Malik |
| 5 | Diagramme de classes | Swann |
| 6 | DSS | Swann |
| 7 | Maquettes UI | Cléry |
| 8 | Critères Bastien & Scapin | Cléry |
| 9 | Implémentation Python | Cléry |
